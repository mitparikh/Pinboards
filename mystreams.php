...
<html>
	<body>
		If you do not have any streams, visit various boards to add them to your existing streams or create new ones.
		<br />
		<br />
		OR if you have click on any one of them to see the boards that you are following in that stream.
		<br />
		<br />
	</body>
</html>
...
$query= "SELECT DISTINCT stream.streamname FROM stream
		WHERE stream.uname='$username'";
...
while($row=mysqli_fetch_array($result))
	{
		...
		echo "<a href='streamBoardView.php?streamname=".$streamname."'>".$streamname.".</br></a>";
	}
?>
