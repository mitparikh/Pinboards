...
$username_of_friend = $_POST['username_of_friend'];
...
$con = mysqli_connect("localhost","root","","pinboards");
	...
	$query = "insert into friendship(sendfriend,acceptfriend) values('$logged_in_username', '$username_of_friend')";
	$result = mysqli_query($con, $query);
	$query2 = "insert into friendship(acceptfriend,sendfriend) values('$logged_in_username', '$username_of_friend')";
