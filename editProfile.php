...
<html>
	<h3> Enter the new values of the following fields : </h3>
	...
	function validate()
	{
	   ...
	   if( document.editProfileForm.lname.value == "" )
	   {
	     alert( "Please provide your Email!" );
	     document.editProfileForm.lname.focus() ;
	     return false;
	   }
	...
	<form name="editProfileForm" action="editProfileQueryRun.php" method="post" onsubmit="return(validate());">
		...
		<input type="submit" name="editProfileSubmit" />
	</form>
</html>
