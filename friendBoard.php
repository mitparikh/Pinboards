...
$username_of_friend = $_GET['uname_of_friend'];

?>
<html><br><br><br><br><br><br><br><br><br><br><br></html>
<html>
	<form action="addFriend.php" method="post" name="addFriendForm" >
					
		<input type="hidden" name="username_of_friend" value="<?php echo "$username_of_friend"; ?>">
		<input type="submit"  value ="add as friend" name="AddFriendButton"/>;
	</form>
</html>
...
$con = mysqli_connect("localhost","root","","pinboards");
	...
	$query = "select pictures.pid, boards.boardname 
				from boards join pin join pictures 
					where boards.boardid = pin.boardid and pin.pid = pictures.pid and boards.uname = '$username_of_friend' 
...
if($result)
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo "</br>";
		echo "<a href='friendBoardView.php?boardname=".$boardname."&uname_of_owner_of_board=".$username_of_friend."'><img src=showImage.php?pictureId=".$row['pid']." width=20% height=20%/></a>";
		echo "</hr>";
	}
}
?>
