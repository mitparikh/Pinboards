...
$query = "select pictures.pid, pictures.tags, pin.pinid from pin join pictures where pin.uname = '$username' and pin.pid = pictures.pid";
...
$_SESSION['pinid'] = $row['pinid'];
//$type = "Content-type: ".$row['aphototype'];
//header($type);
//header("location: tempTrial.php");
